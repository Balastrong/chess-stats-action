...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const chessUsername = (0, core_1.getInput)('CHESS_USERNAME');
            (0, core_1.debug)('Detected username ' + chessUsername + '<<--');
            /*
            const res = await axios.get(
              `https://api.chess.com/pub/player/${chessUsername}/games/2022/07`
            );
        
            setOutput('response', res.data);*/
        }
        catch (error) {
            if (error instanceof Error)
                (0, core_1.setFailed)('XX' + error.message);
        }
    });
}
run();
