...
const getChessComArchives = (username) => __awaiter(void 0, void 0, void 0, function* () {
    const { data } = yield axios_1.default.get(`https://api.chess.com/pub/player/${username}/games/archives`);
...
const getGames = (chessUsername, amount) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const archives = (yield (0, api_1.getChessComArchives)(chessUsername)).slice(0, 5);
