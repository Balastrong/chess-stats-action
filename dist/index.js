...
const fetch_1 = __importDefault(__nccwpck_require__(387));
const getChessComGames = (archive) => __awaiter(void 0, void 0, void 0, function* () {
    const data = yield (0, fetch_1.default)(archive);
...
exports.getChessComGames = getChessComGames;
const getChessComArchives = (username) => __awaiter(void 0, void 0, void 0, function* () {
    const data = yield (0, fetch_1.default)(`https://api.chess.com/pub/player/${username}/games/archives`);
...
// Internal consts
exports.START_TOKEN = '<!--START_SECTION:chessStats-->';
exports.END_TOKEN = '<!--END_SECTION:chessStats-->';
exports.INFO_LINE = '<!-- Automatically generated with https://github.com/Balastrong/chess-stats-action -->\n';
const getGames = (chessUsername, amount) => __awaiter(void 0, void 0, void 0, function* () {
    if (!chessUsername) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.iswitch = void 0;
var validate = function (keys) {
    var duplicates = keys.filter(function (key, index) { return keys.indexOf(key) !== index; });
    if (duplicates.length > 0) {
        throw new Error("Duplicate keys: ".concat(duplicates.join(', ')));
    }
};
var iswitch = function (key, testCase) {
    var testCases = [];
    for (var _i = 2; _i < arguments.length; _i++) {
        testCases[_i - 2] = arguments[_i];
    }
    var allTestCases = __spreadArray([testCase], testCases, true);
    validate(allTestCases.flatMap(function (tc) { return tc[0]; }));
    var handler = allTestCases.find(function (tc) { return (Array.isArray(tc[0]) && (tc[0].length === 0 || tc[0].includes(key))) || tc[0] === key; });
    return handler === null || handler === void 0 ? void 0 : handler[1](key);
};
